...
* [`src/tic_tac_toe/styles.cljs`](src/tic_tac_toe/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/tic_tac_toe/`](src/tic_tac_toe/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/tic_tac_toe/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `tic-tac-toe` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/tic_tac_toe/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns tic-tac-toe.example
